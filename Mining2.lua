...
function pooPoo()
    ...
    do
        ...
        elseif (turtle.getItemDetail().name == "create:brown_toolbox") then
            turtle.placeDown()
            for k1 = 1, 16, 1 
            do  
                turtle.select(k1)
                ...
                elseif (turtle.getItemDetail().name == "minecraft:diamond") then 
                    print("Diamond don't go into the chest")
                elseif (turtle.getItemDetail().name == "minecraft:emerald") then 
                    print("Emeralds don't go into the chest")
                else
                    turtle.dropDown(64)
                end
            end
...
function sortingAlgorithm()
    ...
    if (theData == nil) then 
        ...
        if (theData.name == "create:copper_ore") then
            print(theData.name)
        elseif (theData.name == "create:zinc_ore") then
            print(theData.name)
        ...
        elseif (theData.name == "minecraft:redstone") then 
            print(theData.name)
        elseif (theData.name == "create:brown_toolbox") then
            print(theData.name)
        else 
            turtle.dropDown()
        end
